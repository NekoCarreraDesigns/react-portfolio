...
function Body() {
    return (
        <div className="sea-and-sand" >
            ...
            I do enjoy the functionality of the Back end as well. Apps are made with the MERN stack, Currently learning Python, and Angular. Skills include rigorous testing, debugging, MVC, JSON, user authentication, coding, and reading of documentation, ORM, creating REST API.
            Technologies I know: HTML5, CSS3, Bootstrap, Semantic UI,
             Reactstrap, Materialize, Handlebars, Mongo, Express, Node, React, jQuery, AJAX, JavaScript, ES6, MySQL, Heroku, Github, GitBash, Jest.</p>
